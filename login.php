...
// filename: login.php, Joshua Sopczynski, cis355, 2015-03-30
	...
	if(isset($_POST['loginSubmit'])) // If the user pressed the Submit button
	{
		...
		if ($uname == "username" && $pass == "password")
		{
			...
			if ($_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~jasopczy/cis355/MyProject/animals.php" 
			    || $_SERVER['HTTP_REFERER'] == "http://csis.svsu.edu/~jasopczy/cis355/MyProject/login.php" )
			{
